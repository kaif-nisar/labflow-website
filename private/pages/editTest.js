...
(async function fetchData() {
    ...
    async function populateForm(data) {
        ...
        document.getElementById('hide-method-instrument').checked = data.hideMethodInstrument || false;
        document.getElementById('hide-interpretation').checked = data.hideInterpretation || false;
