...
document.getElementById('submitbBtn').addEventListener('click', async function () {
    ...
    const formData = {
        ...
        hideMethodInstrument: document.getElementById('hide-method-instrument').checked,
        hideInterpretation: document.getElementById('hide-interpretation').checked,
    ...
    await fetch(`${BASE_URL}/api/v1/user/make-test`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
